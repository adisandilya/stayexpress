...
const Hero = () => {
    ...
    const  onSearch = async (e) => {
        ...
        await axios.post('/api/user/recentSearchedCities', {city: destination}, {
  ...
  return (
    ...
    '>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxary and conmfort await at the world's most exclusive hotels and resorts.Start your journey today. </p>
