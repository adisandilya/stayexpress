    ...
    try {
      ...
      if (data.success) {
        if (data.isAvailable) {
          ...
          toast.error(
            "Room is not available for booking on the selected dates"
          );
        }
      } else {
    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
       ...
       mx-auto mt-16 max-w-6xl"
        >
          <div
            className="flex flex-col flex-wrap md:flex-row items-start md:ietms-center gap-4
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            city feeling. The price quoted is for two guest,at the slot please
            mark the number of guests to get the exact price for groups.
          </p>
        </div>
